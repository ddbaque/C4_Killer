...
public class Juga2 extends javax.swing.JFrame {
  ...
  public static void main(String args[]) {
    ...
    System.out.println("Seleccione el enfrentamiento:");
    System.out.println("1. C4_Killer vs Profe");
    System.out.println("2. Profe vs C4_Killer");
    System.out.println("3. C4_Killer vs Aleatori");
    System.out.println("4. Aleatori vs C4_Killer");

    // Leer la opción seleccionada por el usuario
    int opcion = scanner.nextInt();

    // Dependiendo de la opción elegida, asignamos los jugadores
    switch (opcion) {
      case 1:
        // C4_Killer vs Profe
        p1 = crearJugadorC4Killer();
        if (p1 != null) {
          p2 = new Profe(8, true);
        }
        break;
      case 2:
        // Profe vs C4_Killer
        p2 = crearJugadorC4Killer();
        if (p2 != null) {
          p1 = new Profe(8, true);
        }
        break;
      case 3:
        // C4_Killer vs Aleatori
        p1 = crearJugadorC4Killer();
        if (p1 != null) {
          p2 = new Aleatori();
        }
    ...
    if (p1 == null || p2 == null) {
      System.out.println("No se pudieron crear los jugadores correctamente.");
      return;
    }

    // Ejecutar el juego con los jugadores seleccionados
    boolean autoMode = true;
  ...
  private static Jugador crearJugadorC4Killer() {
    try {
      return new C4_Killer(8, true);
    } catch (Exception e) {
      System.err.println("Error al crear el jugador C4_Killer: " + e.getMessage());
  ...
  private void mostraTornActual() {
    jTextField2.setText(
        "TOCA JUGAR " + currentPlayer.nom() + " " + ((currentColor == 1) ? "P1(RED)" : "P2(BLUE)"));
  ...
  private void initComponents() {
    ...
    filler2 =
        new javax.swing.Box.Filler(
            new java.awt.Dimension(0, 400),
            new java.awt.Dimension(0, 400),
            new java.awt.Dimension(32767, 400));
    filler4 =
        new javax.swing.Box.Filler(
            new java.awt.Dimension(0, 400),
            new java.awt.Dimension(0, 400),
    ...
    jLayeredPane1.addMouseListener(
        ...
        layout
            ...
            .addGroup(
                layout
                    .createSequentialGroup()
                    .addGap(57, 57, 57)
                    // .addComponent(jLayeredPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 400,
                    // javax.swing.GroupLayout.PREFERRED_SIZE)
  ...
  private int whichy(int fil) {
    ...
    return getInsets().top
        + this.jLayeredPane1.getY()
        + ((int) Ymax - (fil + 1) * (int) (Ymax / 8.0))
        + m;
  }

  private class MyPanel extends JPanel {}

  private void jLayeredPane1MouseClicked(
      java.awt.event.MouseEvent evt) { // GEN-FIRST:event_jLayeredPane1MouseClicked
  ...
  private void verificaSiHaAcabat(int colu, int color) {
    ...
    if (t.solucio(colu, color) || !t.espotmoure()) {
      ...
      int n =
          JOptionPane.showConfirmDialog(this, dTitle, "Tornar a jugar", JOptionPane.YES_NO_OPTION);
